...
namespace RabbitaskWebAPI.Services
{
    ...
    public interface IUserAuthorizationService
    {
        ...
        Task<bool> EhAgenteAsync(int cdUsuario);
        ...
        Task<List<int>> ObterCdsUsuariosGerenciadosAsync(int cdUsuario);
        ...
        Task<bool> PodeGerenciarUsuarioAsync(int cdUsuarioGerenciador, int cdUsuarioAlvo);
    }
}